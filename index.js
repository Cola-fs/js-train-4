...
function padString(original, length, padWith, side) {
  if (side==="start")
  {
    original=original.padStart(length,padWith)
  }
  else if (side==="end")
  {
    original=original.padEnd(length,padWith) 
  }
  else original="Error: side should be either 'start' or 'end'";
  return original;
...
function trimString(original, side) {
  ...
  else original="Error: side should be either 'start', 'end' or 'both'";
...
function convertCase(original, caseType) {
  if (caseType==="upper")
  {original=original.toUpperCase(original)}
  else  if (caseType==="lower")
  {original=original.toLowerCase(original)}
  else original="Error: caseType should be either 'upper' or 'lower'";
  return original;
